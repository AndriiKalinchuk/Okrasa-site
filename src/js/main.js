...
const animObserver = new IntersectionObserver(handleAnimationIntersection, {
...
document.addEventListener(
  ...
  function () {
    document.dispatchEvent(
      new Event('pjax:success', { bubbles: true, cancelable: true })
    );
  },
  { once: true }
);
